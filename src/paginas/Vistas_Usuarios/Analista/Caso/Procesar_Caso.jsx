...
const ProcesamientoView = ({ isSidebarCollapsed }) => {
  ...
  return (
    <div
      className={`caso-container ${isSidebarCollapsed ? "collapsed" : ""} ${
                      ...
                      <div className="form-group">
                        ...
                        >
                          ...
                          {organizaciones.map((o) => (
                            <option
                              key={o.idOrganizacion}
                              value={o.idOrganizacion}
                            >
              ...
              <div className="casos-card">
                ...
                {casos.length > 0 ? (
                  ...
                  <div className="empty-casos">
                    ...
                    <button
                      onClick={() =>
                        document.getElementById("titulo-caso").focus()
                      }
